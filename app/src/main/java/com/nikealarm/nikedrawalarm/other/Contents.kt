...
object Contents {
    ...
    const val INTENT_KEY_IS_DRAW = "INTENT_KEY_IS_DRAW"

    const val CHANNEL_ID = "channelId"
    const val CHANNEL_ID_AUTO_ENTER = "CHANNEL_ID_AUTO_ENTER"
    const val CHANNEL_ID_SHOES = "CHANNEL_ID_SHOES"
    const val CHANNEL_ID_FIND = "CHANNEL_ID_FIND"
